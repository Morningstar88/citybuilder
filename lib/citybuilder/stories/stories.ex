defmodule Citybuilder.Stories do
  ...
  defp post_changeset(%Post{} = post, attrs \\ %{}) do
    ...
    |> validate_required([:title, :body, :user_id, :topic_id, :plan, :done_so_far_one, :done_so_far_two, :done_so_far_three,  :done_so_far_one_title, :done_so_far_two_title, :done_so_far_three_title, :project_pic, :name_of_gallery, :future_plans_title, :text_pic_one, :text_pic_two, :text_pic_three]) #Need to change this to Para1, Para2 at some point.
  end
