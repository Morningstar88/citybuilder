defmodule Phoenix.HTML.SimplifiedHelpers.Truncate do
  @moduledoc """
  Copy from phoenix_html_simplified_helpers/lib/phoenix_html_simplified_helpers/truncate.ex

  Source library have too many dependencies, this module have none.
  """
